...
from . import logger, extract_k2s as extract
...
class PixSfM:
    ...
    def run_ka( # Where main change should be made
            self,
            ...
            dense_scores: Optional[Dict[str, np.ndarray]] = None,
        ...
        ka_data = self.keypoint_adjuster.refine_multilevel(
                keypoints, feature_manager, graph, descriptors=descriptors)
        del graph
